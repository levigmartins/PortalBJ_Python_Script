...
# Acessa a página de login do Portal
# Access login page
driver.get("https://id.brasiljunior.org.br/sign-in")

# Procura o form de email, espera, para caso da página não ter sido carregada, e insere o email setado nas configs
...
# Procura o form de senha, espera, para caso da página não ter sido carregada, e insere a senha setado nas configs
...
# Acessa a página de Relatórios do Portal e espera um pouco para ter certeza do carregamento da página
# Acess "Relatórios" (Reports) page and waits for page to fully load
driver.get("https://portal.brasiljunior.org.br/relatorios")
sleep(2)

# Clica no botão de download do relatório de 2021
